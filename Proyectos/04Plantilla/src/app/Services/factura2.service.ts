Servicio: import { HttpClient } from '@angular/common/http';
...
export class FacturaService {
  ...
  generarPDF(idFactura: number): Observable<Blob> {
    const formData = new FormData();
    formData.append('idFactura', idFactura.toString());
    return this.lector.post(this.apiurl + 'generar_pdf', formData, { responseType: 'blob' });
  }
}
